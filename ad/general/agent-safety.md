...
> - **功能安全 (ASIL)**：ASIL 等级、PMHF/SPFM/LFM 硬件概率指标、安全架构与冗余
> - **仿真验证与测试**：SOTIF、测试金字塔、场景化测试、SIL/HIL
>
...
>
> 实时主控 (L3+) 与端侧自回归 VLM 之间还差一个数量级。务实路线是：把辅助角色的延迟预算放宽到秒级、缩短输出，等待下一代硬件 (更高内存带宽，如 NVIDIA Thor 级平台)，或改用非自回归/结构化一次性输出的方案。
...
| **ASIL-B** | 中等伤害风险 | <100 FIT (10⁻⁷/h) | 较严格验证 | ESC 稳定控制、安全气囊非关键 |
| **ASIL-C** | 严重伤害风险 | <100 FIT (10⁻⁷/h) | 严格验证+测试 | EPS 电动转向、AEB 辅助制动 |
| **ASIL-D** | 危及生命 | <10 FIT (10⁻⁸/h) | 最严格全流程 | 线控制动、自动驾驶安全监控 |
...
> [!CAUTION]
> **ASIL-D 意味着 PMHF <10 FIT (10⁻⁸ 故障/小时)**
>
