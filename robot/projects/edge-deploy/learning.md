...
*15 章 · 4 部分 — 覆盖人形机器人、机械臂、服务机器人的端侧 AI 全栈技术*

> [!TIP]
> **本篇讲什么**
>
> 通用机器人端侧 AI 全栈技术学习文档，15 章分 4 部分：
>
> - **第一部分 · 平台与基础设施**（第 1~3 章）：端侧算力平台全景、推理框架对比、ROS2 集成
> - **第二部分 · 算法训练与微调**（第 4~7 章）：感知模型训练、VLA 模型、强化学习 Sim2Real、持续学习
> - **第三部分 · 部署与实时控制**（第 8~10 章）：端侧推理部署、实时控制链路、传感器融合
> - **第四部分 · 端侧 Agent 框架**（第 11~15 章）：Agent 架构、LLM 推理引擎、Tool Use、多模态接地、记忆与规划

**第一部分 · 平台与基础设施**（第 1~3 章）
